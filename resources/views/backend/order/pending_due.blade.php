            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <tr>
                        ...
                        <td> <span class="btn rounded-pill btn-info waves-effect waves-light">{{$item->total}}</span></td>
                        <td> <span class="btn rounded-pill btn-warning waves-effect waves-light">{{$item->pay}}</span></td>
                        <td> <span class="btn rounded-pill btn-danger waves-effect waves-light">{{round($item->due)}}</span></td>
                        ...
                        <td>
                            ...
                            data-bs-toggle="modal" data-bs-target="#signup-modal" id="{{ $item->id}}" onclick="orderDue(this.id)">Pay Due</button>
                        </td>
                    </tr>
    ...
    function orderDue(id){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $('#due_display').text('Due Amount: ' + data.due);
            }
        })
    }
</script>
