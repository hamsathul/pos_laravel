...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        @php
            $month_d = date("F");
            $expense = App\Models\Expense::where('month', $month_d)->sum('amount');
        @endphp
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Month Expense</h4> <br>
                        <h4 style="color:aqua; font-size: 30; align: center;">Total: ${{ $expense}}</h4>
