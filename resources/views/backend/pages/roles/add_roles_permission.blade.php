        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Add Roles to Permissions</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="email" class="form-label">All Roles</label>
                                ...
                                <div class="form-check mb-2 form-check-primary">
                                    <input class="form-check-input" type="checkbox" name="" id="customcheck1">
                                    <label class="form-check-label" for="customcheck1">{{$group->group_name}}</label>
                                        ...
                                        <div class="col-9">
                                            ...
                                            <div class="form-check mb-2 form-check-primary">
                                                <input class="form-check-input" type="checkbox" name="permission[]" id="customcheck{{$permission->id}}" value="{{$permission->id}}">
