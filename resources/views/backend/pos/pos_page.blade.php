...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-6 col-xl-6">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="{{ url('/cart-update/'.$cart->rowId)}}">
                                            @csrf
                                        <input type="number" name="qty" id="" value="{{$cart->qty}}" style="width: 40px;" min="1">
                                        <button type="submit" class="btn btn-sm btn-success" style="margin-top: -2px"><i class="fas fa-check"></i></button>
                                    </form>
                                    </td>
                                    <td>{{$cart->price}}</td>
                                    <td>{{$cart->price * $cart->qty}}</td>
                                    <td><a href="{{ url('/cart-delete/'.$cart->rowId)}}"><i class="fas fa-trash-alt" style="color:white"></i></a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                ...
                <div class="bg-primary">
                    ...
                    <p style="font-size: 18px; color:white;">Sub-total: {{Cart::subtotal()}}</p>
                ...
                <form id="myForm" method="post" action="{{ url('/create-invoice')}}">
                    @csrf
                        ...
                        <div class="form-group mb-3">
                            <label for="email" class="form-label">All customer</label>
        ...
        <tr>
            ...
            <td><button type="submit" style="font-size: 20px; color:black;"><i class="fa fa-plus-square"></i></button></td>
