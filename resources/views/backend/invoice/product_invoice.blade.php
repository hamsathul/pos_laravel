                    ...
                    <div class="card-body">
                            ...
                            <div class="float-start">
                                <div class="auth-logo">
                                    <div class="logo logo-dark">
                                        <span class="logo-lg">
                                            <img src="{{ asset('upload/namelogo.png') }}" alt="" height="100">
                                        </span>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 offset-md-2">
                                ...
                                <p><strong>Order No. : </strong> <span class="float-end">{{'BDT'.mt_rand(1000,99999999)}} </span></p>
                                </div>
                            </div><!-- end col -->
                        </div>
                        <!-- end row -->
                        ...
                        <div class="mt-4 mb-1">
                            <div class="text-end d-print-none">
                                ...
                                <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#signup-modal">Create Invoice</button>
                            </div>
                        </div>
                    </div>
                </div> <!-- end card -->
   ...
   <div id="signup-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <form class="px-3" method="post" action="{{ url('/final-invoice') }}">
        ...
        <input class="form-control" type="text" name="pay" placeholder="Pay Now ">
                    ...
                    {{-- <input type="hidden" name="invoice_no" value="{{$nextInvoiceNumber}}"> --}}
