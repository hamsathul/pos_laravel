...
class ExpenseController extends Controller
{
    ...
    public function MonthExpense(){
        ...
        $month_exp = date("F");
        $month = Expense::where('month', $month_exp)->get();
        return view ('backend.expense.month_expense', compact('month'));
    }

    public function YearExpense(){

        $year_exp = date("Y");
        $year = Expense::where('year', $year_exp)->get();
        return view ('backend.expense.year_expense', compact('year'));
    }
}
